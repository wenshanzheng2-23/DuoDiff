...
from model_unet import Difix, load_ckpt_from_state_dict, save_ckpt
...
def main(args):
    ...
    # make the optimizer
    layers_to_opt = []
    # for n, _p in net_difix.unet.named_parameters():
    #     if "lora" in n :
    #         assert _p.requires_grad
    #         layers_to_opt.append(_p)
    #         print(n, _p.requires_grad)
